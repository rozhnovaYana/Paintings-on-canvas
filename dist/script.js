...
var modals = function modals() {
  ...
  var modalHandler = function modalHandler(targetSelector, modalSelector, closeSelector) {
  ...
  var showModal = function showModal(modalSelector, time) {
    var display;
    document.querySelectorAll("[data-modal").forEach(function (i) {
  ...
  var giftAfterScroll = function giftAfterScroll(selector) {
...
var sliders = function sliders(slidesSelector, dir, prevSelector, nextSelector) {
  ...
  var autoPlay = function autoPlay() {
    if (dir == "vertical") {
      paused = setInterval(function () {
        moveSlide(1);
        slides[slide - 1].classList.remove("slideInDown");
        slides[slide - 1].classList.add("slideInUp");
      }, 3000);
    } else {
      paused = setInterval(function () {
        moveSlide(1);
